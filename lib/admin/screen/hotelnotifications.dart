...
class HotelNotificationScreen extends StatefulWidget {
  const HotelNotificationScreen({super.key});

  @override
  _HotelNotificationScreenState createState() => _HotelNotificationScreenState();
}

class _HotelNotificationScreenState extends State<HotelNotificationScreen> {
  ...
  Future<void> sendNotification(String title, String message) async {
    ...
    try {
      await FirebaseFirestore.instance.collection('hotelnotifications').add({
        'title': title,
        'message': message,
